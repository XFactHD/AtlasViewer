...
{
    private static final Component INFO_TITLE = new TranslatableComponent("atlasviewer.message.info.title");
    private static final Component ERROR_TITLE = new TranslatableComponent("atlasviewer.message.error.title");
    private static final Component TITLE_BTN_OK = new TranslatableComponent("atlasviewer.message.btn.ok");
