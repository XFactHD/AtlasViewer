...
public class TextureDrawer
{
     ...
     * @param color Color to tint the texture in
     */
    public static void drawGuiColor(PoseStack pstack, Screen gui, float x, float y, float w, float h, int color)
    {
        startColored();
        fillGuiColorBuffer(pstack, gui, x, y, w, h, color);
        end();
    }
    ...
    public static void fillGuiColorBuffer(PoseStack pstack, Screen gui, float x, float y, float w, float h, int color)
    {
        fillColorBuffer(pstack, x, y, gui.getBlitOffset(), w, h, color);
    }
