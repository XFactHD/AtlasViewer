...
public enum SourceAwareness
{
     ...
     * {@link SpriteResourceLoader#load(ResourceManager, ResourceLocation)}) and therefore does not have a source pack
     */
    SPRITESOURCE_FORCED,
    /**
     ...
     * (i.e. via mixin into {@link SpriteResourceLoader#list(ResourceManager)} and therefore does not have a source pack
     */
