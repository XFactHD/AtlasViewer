...
/// Implemented on [net.minecraft.server.packs.resources.Resource] to allow it to keep track of the resource pack
...
public interface ISpriteSourcePackAwareResource {
    ...
    default @Nullable String atlasviewer$getSpriteSourceSourcePack() {
        throw new UnsupportedOperationException("Not injected");
    }

    /// Get the sprite source that touched this resource
    default @Nullable SpriteSource atlasviewer$getSpriteSource() {
        throw new UnsupportedOperationException("Not injected");
    }
    ...
    default @Nullable Identifier atlasviewer$getOriginalPath() {
        throw new UnsupportedOperationException("Not injected");
    }
}
