package io.github.xfacthd.atlasviewer.client.screen;
...
import io.github.xfacthd.atlasviewer.client.screen.widget.BackgroundSwitchButton;
import io.github.xfacthd.atlasviewer.client.screen.widget.DiscreteSliderButton;
import io.github.xfacthd.atlasviewer.client.screen.widget.IndicatorButton;
import io.github.xfacthd.atlasviewer.client.screen.widget.MenuContainer;
import io.github.xfacthd.atlasviewer.client.screen.widget.SelectionWidget;
import io.github.xfacthd.atlasviewer.client.screen.widget.search.SearchBox;
import io.github.xfacthd.atlasviewer.client.screen.widget.search.SearchHandler;
import io.github.xfacthd.atlasviewer.client.util.ClientUtils;
import io.github.xfacthd.atlasviewer.client.util.QuadTree;
import io.github.xfacthd.atlasviewer.client.util.Rect2i;
...
public final class AtlasScreen extends AtlasViewerScreen implements SearchHandler {
    ...
    private final Map<Identifier, AtlasManager.AtlasEntry> atlases = new HashMap<>();
    private AtlasManager.@Nullable AtlasEntry currentAtlas;
    @Nullable
    ...
    private AtlasInfoScreen.@Nullable AtlasInfo cachedInfo;
